...
import { LayoutDashboard, Users, Receipt, Archive, LogOut, Store, Check, X } from 'lucide-react';
...
export function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-40 flex h-screen w-72 flex-col bg-linear-to-b from-[#071427] via-[#0c1c33] to-[#101f3a] text-slate-100 transition-transform duration-300 md:translate-x-0 ${
